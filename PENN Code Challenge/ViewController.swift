...
class ViewController: UIViewController {
    ...
    private func setupStackView() {
        ...
        NSLayoutConstraint.activate([
            ...
            stackView.bottomAnchor.constraint(lessThanOrEqualTo: fetchButton.topAnchor, constant: -20)
        ])
    }
    ...
    private func updateView(with aqiData: AQIData) {
        DispatchQueue.main.async {
            ...
            if let iaqi = data.iaqi {
                ...
                if let pm10 = iaqi.pm10 {
                    let pm10View = InfoView()
                    pm10View.configure(title: "PM10", value: "\(pm10.v)", advice: "Particulate Matter 10 Level")
                    self.stackView.addArrangedSubview(pm10View)
                }
                ...
                if let w = iaqi.w {
                    let wView = InfoView()
                    wView.configure(title: "Wind", value: "\(w.v)", advice: "Wind Speed")
